...
class SignupForm(forms.Form):
    ...
    def save(self):
        ...
        data.pop('password_confirmation') #Excluimos un dato (no esta definido en nuestro modelo).
        
        user = User.objects.create_user(**data) # Podriamos enviar como (email=data['email'],..) |(**data) envía.todos.los.datos.
