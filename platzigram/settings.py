...
LOGIN_REDIRECT_URL = '/' #Aqui redireccionamos a "nuestro feed (/)" esto se defin al utilizar la clase "LoginView(auth_view..)"
LOGOUT_REDIRECT_URL = LOGIN_URL #Aqui redireccionamos al hacer "logout"
...
EMAIL_HOST_PASSWORD = 'tucontrasema'
